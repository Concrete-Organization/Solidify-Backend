...
namespace Solidify.Infrastructure.Migrations
{
    ...
    [Migration("20250220123055_addProductNametoOrderItemTable")]
    partial class addProductNametoOrderItemTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Solidify.Domain.Entities.ECommerce.ShippingDetails", b =>
                {
                    ...
                    b.HasOne("Solidify.Domain.Entities.ECommerce.Order", "Order")
                        ...
                        .HasForeignKey("Solidify.Domain.Entities.ECommerce.ShippingDetails", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
